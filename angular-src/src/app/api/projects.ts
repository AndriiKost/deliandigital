...
export const ProjectsAPI = {
    projects: [
      ...
      },
      {
        ...
        role: 'Our role was to completely redesign, re-engineer and improve the performance of the existing website. Create interactive User Experience, modern User Interface. We also helped with the innovation of internal and external software infrastructure and tools of the company. For this project, We choose WordPress, because the current team had experience with it.',
      ...
      },
      {
        ...
        role: 'Our role was to re-engineer and redesign an existing WordPress website with very custommized User Interface components. We worked with client\s marketing team to establish an online presence they never had before.',
      ...
      },
      {
        ...
        result: 'As a result of our hard work with Kunze Analytics, we achieved the milestones we set at the beginning of our journey by multiplying client\'s Return on Investment, integrated blog platform with many excellent resources and executive summaries.',
